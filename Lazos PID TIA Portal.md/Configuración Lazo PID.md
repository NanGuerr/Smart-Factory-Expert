...
El controlador calcula de forma continua el error instantáneo $e_(t) = SP - PV_(t)$ para calcular la acción de control ($Out(t)$) sumando el efecto de tres componentes esenciales:
