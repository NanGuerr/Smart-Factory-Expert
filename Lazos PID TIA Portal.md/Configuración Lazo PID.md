...
El controlador calcula de forma continua el error instantáneo $e_t = SP - PV_(t)$ para calcular la acción de control $Out_(t)$ sumando el efecto de tres componentes esenciales:
