...
Introduce el lenguaje **Texto Estructurado (ST)**, un lenguaje de programación de **alto nivel** definido por la norma IEC 61131-3. A diferencia de los lenguajes gráficos o de bajo nivel, el ST es altamente legible para los humanos, pareciéndose a lenguajes de programación como C o Pascal.
