...
Durante la ejecución, el script imprime métricas clave de balanceo de datos para el analista, calculando la **tasa de fallas (Failure Rate)**: $$ext{Tasa de Fallas}=\left(rac{ext{Filas con falla en siguientes 7 días}}{	ext{Total de registros generados}}ight)imes100$$
