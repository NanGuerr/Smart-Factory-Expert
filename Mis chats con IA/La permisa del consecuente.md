...
### 1. Cambiar un foco con el interruptor encendido 💡
* **Veredicto:** POSIBLE.
* **Detalle:** Es una práctica común (aunque **muy peligrosa**). Si el interruptor corta la fase y no el neutro, la parte metálica que sostiene la bombilla puede estar energizada, lo que conlleva un alto riesgo de electrocución. Sin embargo, es físicamente posible hacerlo sin que ocurra una catástrofe inmediata si se tiene cuidado de no tocar los contactos internos del portalámparas.

### 2. Activar un ramal eléctrico y que el tablero principal se incendie ⚡
* **Veredicto:** POSIBLE.
* **Detalle:** Esto es un escenario técnico real. Si el ramal que intentaste activar tenía un cortocircuito grave o si la capacidad del interruptor (breaker) y el cableado estaban mal dimensionados, al cerrar el circuito se produce una sobrecarga instantánea. Un arco eléctrico o un sobrecalentamiento extremo en las barras del tablero puede causar un incendio de forma casi inmediata si las protecciones fallan o son inexistentes.
...
> *Puedo descifrarlo, es muy obvio... Al parecer el chat temporal solo es un distractorio...*
